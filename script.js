...
function addEntry(event) {
	...
	const journalEntryName = document.getElementById("journal-entry-name").value;
	...
	entryTitle.textContent = journalEntryName;
	newEntry.appendChild(entryTitle);
	const entryContent = document.createElement("p");
	entryContent.textContent = journalEntry;
	...
	document.getElementById("journal-entry-name").value = "";
	document.getElementById("journal-entry").value = "";
}

function editEntry(entry) {
	const entryTitle = entry.querySelector("h2");
	const entryContent = entry.querySelector("p");
	const journalEntryName = prompt("Enter new name for journal entry:", entryTitle.textContent);
	if (journalEntryName === null) {
		return;
	}
	const journalEntry = prompt("Enter new content for journal entry:", entryContent.textContent);
